...
ggsave(plot=g,"/data3/lishuhan/30GSE_health_SRR/v3AS/SRR_info/plot/v2_info.pdf"
...
p
ggsave(plot=p,"/data3/lishuhan/30GSE_health_SRR/v3AS/SRR_info/plot/v2_young_info.pdf",
       width = 10,height=6,dpi=300)


rm(list = ls())
a<-read.csv("/data3/lishuhan/30GSE_health_SRR/v2AS/v2SRR/df_0_17.csv")
b<-read.csv("/data3/lishuhan/30GSE_health_SRR/v2AS/v2SRR/v2_df_17_59.csv")
c<-read.csv("/data3/lishuhan/30GSE_health_SRR/v2AS/v2SRR/df_60_100.csv")
colnames(c)[2]<-"Sample_Name"
d<-rbind(a,b,c)
write.csv(d,"/data3/lishuhan/30GSE_health_SRR/v3AS/SRR_info/health.csv")
##年龄分布图
...
p2
ggsave(plot=p2,"/data3/lishuhan/30GSE_health_SRR/v3AS/SRR_info/plot/v2_old_info.pdf",
       width = 10,height=6,dpi=300)
(p)/(p2)
ggsave(plot=(p)/(p2),
       "/data3/lishuhan/30GSE_health_SRR/v3AS/SRR_info/plot/merge_yo_info.pdf",width = 10,height=12,dpi=300)